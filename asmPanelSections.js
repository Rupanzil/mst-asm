...
import { getSecDiagonalsForSameSecDiagonals,
    getSecDiagonalsForDifferentSecDiagonals } from "./asmSecondaryDiagonals.js";
...
function createMainHorizontals(towerData, totalNumberofPanels) {
    ...
    towerData.forEach( (line, lineNumber) => {
        ...
        if( line.includes('FACE') ) {               // 'FACE' is only included in the panel sections
            ...
            } else if (panelFacesNotHavingMainHorizontals.includes(currentPanelFace) && towerData[lineNumber + 1].includes('PLAN') ) {
